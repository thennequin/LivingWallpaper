...
vec3 noised( in vec2 x )
{
	...
	float a = noisef((p+vec2(0.5,0.5))/256.0);
	float b = noisef((p+vec2(1.5,0.5))/256.0);
	float c = noisef((p+vec2(0.5,1.5))/256.0);
	float d = noisef((p+vec2(1.5,1.5))/256.0);
